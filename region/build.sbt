...
libraryDependencies ++= 
  Seq(
    ...
    "com.typesafe.akka" % "akka-cluster-sharding_2.11" % akkaVersion % Provided,
    ...
    "com.typesafe.akka" % "akka-persistence_2.11" % akkaVersion % Provided,
    "com.github.scullxbones" % "akka-persistence-mongo-common_2.11" % "1.2.1" % Provided,
    "com.github.scullxbones" % "akka-persistence-mongo-casbah_2.11" % "1.2.1" % Provided,
    "com.typesafe.akka" % "akka-persistence-query-experimental_2.11" % akkaVersion % Provided,
