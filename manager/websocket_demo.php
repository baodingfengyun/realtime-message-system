...
// 	  	  		alert(msg);
	...
	function sub(_type) {
		...
		connect.sendCmd(code+"_"+topic, _type, token,Math.ceil(Math.random()*100));
	}
</script>
</head>
<body>
	...
	<div class="container-fluid">
		<ul class="nav nav-tabs" role="tablist">
		  <li role="presentation"><a href="demo.php">Socket.io</a></li>
		  <li role="presentation" class="active"><a>WebSocket</a></li>
